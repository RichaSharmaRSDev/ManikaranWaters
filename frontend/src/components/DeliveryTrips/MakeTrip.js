...
import { IconTruckDelivery, IconChartBar, IconCheck } from "@tabler/icons-react";
        ...
        <>
          {isMobile ? (
            <div className="et-mobile-header">
              <div className="mt-mobile-row1">
                <label className="mt-mobile-datechip">
              ...
              <div className="mt-mobile-controls">
                ...
                <span className="maketrip-count">{selectedCustomers.length} <IconCheck size={12} /></span>
          ...
          <div className="maketrip-table">
            <div className="maketrip-thead">
              ...
              <div className="mt-zone mt-mobile-hide">ZONE</div>
              <div className="mt-freq mt-mobile-hide">FREQ</div>
              <div className="mt-date mt-mobile-hide">NEXT DELIVERY</div>
              <div className="mt-date mt-mobile-hide">LAST DELIVERY</div>
              ...
              {customersPredictions?.map((customer) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-zone mt-mobile-hide">{customer.zone}</div>
                    <div className="mt-freq mt-mobile-hide">{customer.frequency}</div>
                    <div className="mt-date mt-mobile-hide">
